...
INSTALLED_APPS = [
    ...
    "swo_playground.extension.ExtensionConfig",
]
...
SERVICE_NAME = os.getenv("SERVICE_NAME", "Swo.Extensions.Playground")
...
INITIALIZER = os.getenv("MPT_INITIALIZER", "swo_playground.initializer.initialize")
